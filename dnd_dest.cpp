...
static void on_drag_data_received(GtkWidget* widget, GdkDragContext* drag_context, gint x, gint y, GtkSelectionData* selection_data, guint info, guint time, gpointer user_data)
{
...
int main(int argc, char* argv[])
{
    ...
    gtk_drag_dest_set(window, GTK_DEST_DEFAULT_ALL, &target_entry, 1, GDK_ACTION_COPY);
